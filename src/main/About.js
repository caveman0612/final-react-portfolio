    ...
    <div id="about" style={{}} className=" border-bottom py-5">
      ...
      <div className="container w-75">
        <p>
          ...
          doing it as a hobby since, but about a year ago, I realized that I
        ...
        <p>
          ...
          in my knowledge and help me land my first job in the tech world.
        </p>
        <p>
        ...
        <p>
          ...
          doing carpentry and woodcarving since I was a little boy living in
          rural Minnesota.
        </p>
      </div>
    </div>
